...
//  - L3_local_FSM + L3_PU
//  - intermid2_3 URAM R-port ?��?��?���? (L2_top ?�� 4�? URAM ?��?�� ?���?)
//  - URAM/output addr ?��?��. final pixel 16bit + valid 그�?�? ?���?.
...
module L3_top #(
    ...
    input  wire                          i_rstn,
    input  wire                          i_start,
    input  wire                          i_image_bit,    // global FSM?��?�� 주입
    ...
    wire [63:0] w_pu_input_data  = {w_ch[3], w_ch[2], w_ch[1], w_ch[0]}; // ?��?�� 컨벤?��
    wire        w_pu_input_valid = i_l2_rd_valid[0]; // 4ch ?��기이�?�? [0]�? 참조
