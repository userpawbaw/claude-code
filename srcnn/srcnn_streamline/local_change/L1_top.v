...
//
//   Sub-blocks:
//     - L1 image BRAM     (16-bit √ó 22500, INIT_FILE)
//     - L1 weight BRAM    (64-bit √ó 20,    INIT_FILE)
//     - L1_local_FSM
//     - L1_PU              (in_ch=1, out_ch=8 parallel)
//     - intermid1_2 URAM  (128-bit √ó 45000)  ?Üê W-side here, R-port exposed for L2_top
//
//   Memory layout (URAM):
//     addr[15]   = image_bit          (?ù¥ÎØ∏Ï? ?òÅ?ó≠ ÍµêÏ∞®)
//     addr[14:0] = pixel_idx (0~22499) (raster order, 150√ó150)
//     data[127:0] = {ch7, ch6, ..., ch1, ch0}  (LSB ?ïà?èÑ?óê ch0; L2_PU.i_uram_data[16*i+:16] Í≥? ?Üç?èÑ?? ?ùºÏπ?)
// -----------------------------------------------------------------------------
...
module L1_top #(
    ...
    L1_PU u_pu (
        ...
        .i_w_rd_en             (w_w_rd_valid),     // 1clk-delayed weight rd_en ?Üí align with rd_dout
    ...
    // =========================================================================
    // intermid1_2 URAM (128-bit √ó 45000)
    // =========================================================================
