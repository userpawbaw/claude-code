...
//
// Row 경계는 자연 정렬됨 :
//   row N (N=0,2,4,...) 끝나면 cnt=2 (save={col148,col149}).
//   row N+1 K=0 (2px) 들어오면 cnt=2 + 2px → emit={r_N_c148, r_N_c149, r_N+1_c0, r_N+1_c1},
//                                            cnt=0.
//   150 rows (짝수) 처리 후 cnt=0 으로 깔끔하게 종료.
//
...
//
// 출력 word 도 같은 순서 : o_data[63:48] = 가장 왼쪽(오래된) col.
